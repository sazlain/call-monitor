...
class DashboardRepositoryImplTest {
    ...
    void findRecentEvents_returnsMappedList() {
        // findRecentEvents usa CallEventEntity mapeado via CallEventMapper::entityToDomain
        CallEventEntity entity = CallEventEntity.builder()
                .id(1L).callId("CALL-001").callerIdNum("5551001").callerIdName("John")
                .calledNumber("5550001").callerExtension("1001").build();
